...
from dask.distributed import Client, Future, wait, as_completed, progress
from typing import Iterable


def new_dask_client(*args, **kwargs):
    '''Temporary wrapper for new_dask_client_slurm for transition.'''
    return new_dask_client_slurm(*args, **kwargs)
